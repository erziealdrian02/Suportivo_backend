...
<div id="mydata">
    ...
    <br>
    <?php
    $q = $this->db->query("select * from sub_category where id_sub_category=".$id);
        ...
        ?>
    <form method="POST" action="<?php echo base_url('crud/edit/'.$id);?>">
...
?>
           ...
           <tr>
                ...
                <td><b><input class="form-control" style="width: 200px !important;" type="text" name="name[]" value='<?php echo "$d->nama_spek"; ?>' /></b></td>
                <td><b><textarea class="ckeditor" style="width: 300px !important;" name="value[]"><?php echo "$d->value_spek"; ?></textarea></b></td>
                <td><b><input class="form-control" style="width: 70px !important;" type="number" name="urut[]" value='<?php echo "$d->num"; ?>' /></b></td>
            </tr>
            </tbody>
    ...
    <br>
            <div class="col-xs-12 text-left">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('user/daftarproduk'); ?>"><i class="fa fa-reply"></i> Back</a>
                </div>
            </div>